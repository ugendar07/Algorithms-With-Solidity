...
import "../contracts/MergeSort.sol";

contract MergeSortTest is MergeSort {
    MergeSort mergeSort;
    ...
    function testSortsAnEmptyArray() view public {
        // Arrange
        ...
        for (uint256 i = 0; i < result.length; i++) {
            require(result[i] == expectedResult[i], "Array elements differ");
        }
    }

    function testSortsAnArrayWithLength1() view public {
        // Arrange
    ...
    function testSortsAnArrayWithLength2() view public {
        // Arrange
    ...
    function testSortsAnArrayWithOddLength() view public {
        // Arrange
        // [33,69,27,5,14,7,47]
    ...
    function testSortsAnArrayWithEvenLength() view public {
        // Arrange
